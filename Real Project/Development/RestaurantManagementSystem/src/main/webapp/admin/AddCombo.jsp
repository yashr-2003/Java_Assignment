...
<head>
  ...
  .booking-card img {
    ...
    height: 200px; /* Sets a consistent image height */
  ...
  @media (max-width: 768px) {
    .booking-card {
      max-width: 100%; /* Adjusts the card width to be 100% on small screens */
      margin-left: 10px;
      margin-right: 10px;
    }
  }
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="booking-card">
              ...
              <img src="<%= request.getContextPath() + "/images/" + rs.getString(7) %>" alt="Restaurant Image">
         
              <p><strong>Address:</strong> <%= rs.getString(3) %></p>
              <p><strong>Popular Food:</strong> <%= rs.getString(4) %></p>
            </div>
          </div>
          <% 
              } // End of while loop
