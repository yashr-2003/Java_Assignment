...
<!-- Navbar & Hero Start -->
        <div class="container-xxl position-relative p-0">
                    ...
                    <div class="navbar-nav ms-auto py-0 pe-4">
                  	  ...
                  	  <div class="navbar-nav ms-auto py-0 pe-4">
                            ...
                            <div class="dropdown-menu m-0">
                                <a href="clogin.jsp" class="dropdown-item">Login</a>
                                <a href="cregistration.jsp" class="dropdown-item">Registration</a>
                            </div>
                        </div>
			...
			<form action="customercontroller" method="get">
 	  			 <button type="submit" name="action" value="nobook" class="btn btn-primary py-2 px-4">Book A Table</button>
			</form>
                </div>
            </nav>
